...
public class PirateChest {
	 ...
	 * 
	 * @param gold
	 *            int representing positive number of gold pieces to place into
	 *            the chest.
	 */
	 ...
	 * 
	 * @param gold
	 *            int greater than 0 representing number of pieces of gold to
	 *            add to the chest.
	 */
	 ...
	 * 
	 * @param gold
	 *            positive int representing the number of pieces to remove from
	 *            the trunk
	 */
